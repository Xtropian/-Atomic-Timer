...
2. Ensure `bomb.png`, `beep.wav`, `armbomb.wav`, and `explode.wav` are in the root directory.
3. Open `index.html` in any modern browser.
4. Set Time:** Click directly on the Minutes or Seconds digits to increment.
5. Arm:** Press `S` to start the countdown.

## 💻 Tech Stack
- HTML5 / CSS3 (Custom Blending Modes & Drop Filters)
- Vanilla JavaScript (DOM Manipulation & Keyboard Event Listeners)
